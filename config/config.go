...
var (
	...
	CHROMEDRIVER             string = setting.String("chromedriver")                                          // Surfer-Phantom下载器：phantomjs程序路径
	IEDRIVER                 string = setting.String("iedriver")                                          // Surfer-Phantom下载器：phantomjs程序路径
